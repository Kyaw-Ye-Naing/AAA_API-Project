...
namespace AAA_API.Controllers
{
    ...
    public class BalanceController : ControllerBase
    {
        ...
        public BalanceController(ILogger<BalanceController> logger, Gambling_AppContext context, IConfiguration configuration)
        {
            _logger = logger;
            _context = context;
            _configuartion = configuration;
        }
        // ADDING BALANCE : api/Balance/add/5
        [HttpPut("add/{id}")]
        ...
        // REMOVING BALANCE :  api/Balance/remove/5
        [HttpPut("remove/{id}")]
        [Authorize(Policy = "Person")]
